...
// Push API \ Publish Picture On Facebook
// https://docs.oneall.com/api/resources/push/facebook/picture/
...
// Make request
$oneall_curly->post (SITE_DOMAIN . "/push/identities/" . $identity_token . "/facebook/picture.json", $request_structure_json);
