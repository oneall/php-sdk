...
// Push API \ Upload Video On Facebook
// https://docs.oneall.com/api/resources/push/facebook/video/
...
// Make request
$oneall_curly->post (SITE_DOMAIN . "/push/identities/" . $identity_token . "/facebook/video.json", $request_structure_json);
