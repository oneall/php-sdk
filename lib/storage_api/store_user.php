...
// Users \ Store a new user in the cloud-hosted database
// http://docs.oneall.com/api/resources/storage/users/create-user/

// Message Structure
$structure = array(
	'request' => array(
		'user' => array(
			'login' => 'john@.doe@example.111' . rand (),
			//'externalid' => 'jd123451111d1111',
			'identity' => array(
				'name' => array(
					'givenName' => 'John',
					'middleName' => 'Jr',
