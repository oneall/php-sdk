 ...
 */
class SteamTest extends TestingApi
{
    /**
     * @var \Oneall\Api\Apis\Provider\Steam
     */
    protected $sut;
    ...
    {
        parent::setUp();
        $this->sut = new Steam($this->client, $this->timeout);
    }

    public function testGetName()
    {
        $this->assertEquals('steam', $this->sut->getName());
    }
